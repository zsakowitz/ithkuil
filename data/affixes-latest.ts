...
export const affixes = /* @__PURE__ */ deepFreeze<AffixEntry[]>([
  ...
  },
  {
    ...
    degrees: [
      ...
      "with accompanying inward-outward swinging motion",
      "with accompanying side-to-side swinging motion",
      "with accompanying up-and-down “bobbing” motion",
      "with accompanying inward-outward overhead arc-like motion",
  ...
  },
  {
    ...
    degrees: [
      ...
      "inhabitants/species/exemplars for that niche",
  ...
  },
  {
    ...
    degrees: [
      ,
      "[same as COO/1 affix above, but with partially exclusive “or”, where, among three or more referents, 2 or more of the referents may quasi-sequentially occur, but not all of them]",
      "[same as COO/2 affix above, but with partially exclusive “or”, where, among three or more referents, 2 or more of the referents may quasi-sequentially occur, but not all of them]",
      "[same as COO/3 affix above, but with partially exclusive “or”, where, among three or more referents, 2 or more of the referents may quasi-sequentially occur, but not all of them]",
      "[same as COO/4 affix above, but with partially exclusive “or”, where, among three or more referents, 2 or more of the referents may quasi-sequentially occur, but not all of them]",
      "[same as COO/5 above, but with partially exclusive “or”, where, among three or more referents, 2 or more of the referents may occur, but not all of them, where simultaneity vs. sequentiality of the referents is either unknown, unspecified, or irrelevant]",
  ...
  },
  {
    ...
    degrees: [
      ,
      "every X millenia",
      "every X 10000 year periods",
      "every X 10⁵ year periods",
      "every X ages (10⁶ years)",
      "every X epochs (10⁷ years)",
      "every X eras (10⁸ years)",
      "every X eons (5×10⁸ years)",
      "every X billion (10⁹) year periods",
      "every X universe-lifespans",
    ],
  },
  {
    cs: "rţw",
