...
export const CORES = deepFreeze({
  ...
  ḑ: {
    shape:
      "M 30 -35 l -50 0 l -10 10 l 0 40 l 9.5 -9.5 l 20.65 29.5 l 7.65 -7.65 l -21.65 -30.8 l -6.2 6.2 l 0 -27.6 l 40 0 l 10 -10 z",
    top: ["horiz", 30],
    bottom: ["diag", 0.2],
  },
  f: {
  ...
  g: {
    shape:
      "M 27.825 -25 l 10 -10 l -65.75 0 l -9.9 10.1 l 30.45 37.55 l 7.25 -7.3 l 24.15 29.65 l 7.45 -7.4 l -25.2 -31.05 l -7.5 7.45 l -23.1 -28.85 l 52.15 0 z",
    top: ["horiz", 37.825],
    bottom: ["diag", 24.025],
  },
  h: {
  ...
  k: {
    shape:
      "M -27.9 -35 l -9.9 9.85 l 48.75 60.15 l 7.5 -7.5 l -42.7 -52.55 l 52.05 0 l 10 -9.95 l -65.75 0 z",
    top: ["horiz", 37.825],
    bottom: ["diag", 10.975],
  },
  l: {
  ...
  n: {
    shape:
      "M -8.85 -34.85 l -10 10 l 0 40 l 9.55 -9.55 l 20.65 29.4 l 7.5 -7.5 l -21.6 -31 l -6.1 6.1 l 0 -37.6 z",
    top: ["vert", -8.85],
    bottom: ["diag", 11.35],
  },
  ň: {
    shape:
      "M -8.65 -25.1 l 0 25 l -8.45 8.45 l 26.7 26.65 l 7.5 -7.5 l -25.5 -25.5 l 9.75 -9.7 l 0 -27.3 l -10 10 z",
    top: ["vert", 1.35],
    bottom: ["diag", 9.6],
  },
  p: {
  ...
  ř: {
    shape:
      "M -16.55 -35 l -7.45 7.55 l 22.75 22.7 l -9.75 9.8 l 0 29.95 l 25 0 l 10 -10 l -25 0 l -0.1 -27.55 l 8.55 -8.5 z",
    top: ["diag", -16.55],
    bottom: ["horiz", 14],
  },
  s: {
    shape:
      "M 27.5 -35 l -10 10 l 0 20 l -35 0 l -10 10 l 29.95 30 l 7.5 -7.5 l -22.45 -22.45 l 30 0 l 10 -10 l 0 -30 z",
    top: ["vert", 27.5],
    bottom: ["diag", 2.45],
  },
  š: {
  ...
  ţ: {
    shape:
      "M 30 -35 l -50 0 l -10 10 l 0 27 l 33.1 33 l 7.5 -7.4 l -30.6 -30.6 l 0 -22 l 40 0 l 10 -10 z",
    top: ["horiz", 30],
    bottom: ["diag", 3.1],
  },
  v: {
  ...
  x: {
    shape:
      "M 37.825 -35 l -65.75 0 l -9.9 9.9 l 25.7 25.7 l -7.5 7.5 l 26.9 26.9 l 7.5 -7.5 l -25.7 -25.7 l 7.45 -7.55 l -19.3 -19.3 l 50.6 0 z",
    top: ["horiz", 37.825],
    bottom: ["diag", 7.275],
  },
  z: {
    shape:
      "M 14.775 4.85 l 10 -10 l -29.85 -29.85 l -7.5 7.5 l 22.35 22.35 l -20 0 l -14.55 14.55 l 25.6 25.6 l 7.5 -7.5 l -23.1 -23.1 l 30 0 z",
    top: ["diag", -4.85],
    bottom: ["diag", 0.6],
  },
  ż: {
  ...
  ž: {
    shape:
      "M -8.05 -35 l -7.5 7.45 l 22.55 22.55 l -14.4 0 l -17.6 17.65 l 0 22.35 l 40 0 l 10 -10 l -40 0 l 0 -20 l 30 0 l 8.5 -8.5 z",
    top: ["diag", -8.05],
    bottom: ["horiz", 15],
  },
